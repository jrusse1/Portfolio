...
def isEnglish(message, wordPercentage=60):
    wordsMatch = getEnglishCount(message) * 100 >= wordPercentage
    return wordsMatch

def findDecryptionKey(ciphertext):
